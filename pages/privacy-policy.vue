<template>
  <div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <p class="mb-4 text-gray-500">If you have any questions about this privacy policy, please contact us at: <a href="mailto:info-ngebir@di-mana.com" class="text-gray-700 font-semibold hover:underline">info-ngebir@di-mana.com</a>.</p>
