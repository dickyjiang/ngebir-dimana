              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-0">
                ...
                >
                  ...
                  <div class="mb-8">
                    ...
                    <div
                      class="flex flex-col items-center mt-2 border bg-gray-100 border-gray-300 rounded-md px-3 py-2"
                    >
                      <p class="text-gray-500 text-sm">
                        Click untuk panduan cara menemukan Google location_link
                        anda
                      </p>
                      <button
                    ...
                    >
                      <div class="space-y-1 text-center">
                        ...
                        >
                          <label
                            for="logo"
                            class="relative cursor-pointer rounded font-medium text-gray-800 hover:text-gray-500"
                          >
                    ...
                    >
                      <div class="space-y-1 text-center">
                        ...
                        >
                          <label
                            for="cafeImage"
                            class="relative cursor-pointer rounded-md font-medium text-gray-800 hover:text-gray-500"
                          >
