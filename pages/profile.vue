<template>
  <div class="bg-gray-100 min-h-screen py-8">
    <div
      class="max-w-6xl mx-auto py-8 px-12 rounded-2xl bg-white"
      v-if="user">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 ">
        ...
        <div class="pl-8">
          ...
          <div class="w-full border border-gray-300 rounded-md p-4 mb-4">
            <img src="/img/noImg.webp" alt="cafe_pic" class="w-full h-64 object-cover" />
            ...
            <div class="mt-2 flex justify-end w-full">
              <button class=" bg-blue-500 text-white py-3 px-8 rounded-md text-base font-medium hover:bg-blue-600 transition-colors disabled:bg-blue-300 disabled:cursor-not-allowed">edit</button>
            </div>
          </div>
          <div class="w-full border border-gray-300 rounded-md p-4 mb-4">
            <img src="/img/noImg.webp" alt="cafe_pic" class="w-full h-64 object-cover" />
